...
class AlasGUI(Frame):
    ...
    def show(self) -> None:
        ...
        with use_scope("content"):
            put_text("Chọn ngôn ngữ | Select your language").style("text-align: center")
            put_buttons(
                [
            ...
            put_text("Giao diện | Change theme").style("text-align: center")
            put_buttons(
                [
    ...
    def run(self) -> None:
        # setup gui
        set_env(title="Emulator Helper", output_animation=False)
